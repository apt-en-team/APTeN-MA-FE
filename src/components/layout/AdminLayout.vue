    ...
    <div class="main">
      <header class="topbar">
        ...
        <div class="topbar-right">
          ...
          <!-- 페이지별 액션 버튼 — @click은 모두 handleActionClick으로 통일 -->
          <button
            v-if="route.name === 'AdminVisitorVehicleList'"
            class="btn-action"
          ...
          <button
            v-if="route.name === 'AdminFixedVisitorVehicleList'"
            class="btn-action"
            @click="handleActionClick"
          >
            + 고정 방문차량 등록
          ...
          <button
            v-if="route.name === 'AdminFacilityManage'"
            class="btn-action"
          ...
          <button
            v-if="route.name === 'AdminBoardList'"
            class="btn-action"
            @click="handleActionClick"
          >
            + 공지 작성
          ...
          <button
            v-if="route.name === 'AdminParkingLog'"
            class="btn-action"
            @click="handleActionClick"
          >
            + 기록 등록
          ...
          <button
            v-if="route.name === 'AdminVehicleListView'"
            class="btn-action"
            @click="handleActionClick"
          >
            + 차량 등록
          ...
          <button
            v-if="route.name === 'AdminFacilityStatus'"
          ...
          <button
            v-if="
              gxPendingCount > 0 &&
              (route.name === 'AdminReservationListView' ||
                route.name === 'AdminFacilityStatus')
            "
          ...
          <button
            v-if="route.name === 'AdminReservationListView'"
            class="btn-action"
