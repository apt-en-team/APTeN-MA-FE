...
// PENDING이면 잠금 페이지로, 아니면 해당 경로로 이동
function navTo(path) {
  if (isPending.value) {
  ...
  <div class="layout">
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <a class="nav-item" :class="{ 'nav-locked': isPending }" @click.prevent="navTo('/resident/my-vehicle')">
          <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
        ...
        <a class="nav-item" :class="{ 'nav-locked': isPending }" @click.prevent="navTo('/resident/visitor-vehicles/list')">
        ...
        <a class="nav-item" :class="{ 'nav-locked': isPending }" @click.prevent="navTo('/resident/visitor-vehicles/fixed')">
          <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
        ...
        <a class="nav-item" :class="{ 'nav-locked': isPending }" @click.prevent="navTo('/resident/parking/status')">
          <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
        ...
        <a class="nav-item" :class="{ 'nav-locked': isPending }" @click.prevent="navTo('/resident/facility')">
          <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
        ...
        <a class="nav-item" :class="{ 'nav-locked': isPending }" @click.prevent="navTo('/resident/my-reservation')">
          <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
        ...
        <a class="nav-item" :class="{ 'nav-locked': isPending }" @click.prevent="navTo('/resident/board/notice')">
          <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
        ...
        <a class="nav-item" :class="{ 'nav-locked': isPending }" @click.prevent="navTo('/resident/board')">
        ...
        <a class="nav-item" :class="{ 'nav-locked': isPending }" @click.prevent="navTo('/resident/board/my-posts')">
          <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
.nav-item.nav-locked .nav-icon { stroke: #B0B5C3; }
.nav-item.nav-locked:hover .nav-icon { stroke: #B0B5C3; }
...
.btn-bell {
  ...
  padding: 8px 16px; border: 1px solid #E0E3EB;
