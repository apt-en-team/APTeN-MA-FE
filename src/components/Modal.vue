...
const props = defineProps({
  ...
  // 'admin' → 네이비 (#2B3A55) | 'resident' → 파랑 (#4973E5)
...
<template>
  <!-- hideFooter: true → footer 슬롯 숨기고 body 안에 버튼 직접 배치 → 가운데 정렬 -->
...
.result-icon-success { background: rgba(77, 139, 90, 0.14); }
.result-icon-danger  { background: rgba(229, 62, 62, 0.12); }
.result-icon-warning { background: rgba(192, 139, 45, 0.14); }
