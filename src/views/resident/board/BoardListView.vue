      ...
      <div class="board-main">
        ...
        <div class="tab-bar">
          <div class="tabs">
            ...
            <button class="tab-btn" :class="{ active: activeTab === 'INQUIRY' }" @click="setTab('INQUIRY')">문의사항
            </button>
          </div>
            ...
            <li class="popular-item" v-for="post in popularPosts" :key="post.boardId"
              ...
              <div class="popular-text-wrap">
                ...
                <div class="popular-meta">
                  <span class="stat-item">
                    <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" width="13"
                         height="13">
                      <path stroke-linecap="round" stroke-linejoin="round"
                            d="M2.25 12.76c0 1.6 1.123 2.994 2.707 3.227 1.087.16 2.185.283 3.293.369V21l4.076-4.076a1.526 1.526 0 0 1 1.037-.443 48.282 48.282 0 0 0 5.68-.494c1.584-.233 2.707-1.626 2.707-3.228V6.741c0-1.602-1.123-2.995-2.707-3.228A48.394 48.394 0 0 0 12 3c-2.392 0-4.744.175-7.043.513C3.373 3.746 2.25 5.14 2.25 6.741v6.018Z"/>
                    </svg>
              ...
              <div class="my-post-info">
                ...
                <div class="my-post-actions">
                  <button class="action-btn edit" @click.stop="router.push(`/resident/board/form?id=${post.boardId}`)">
                    <svg fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="12"
                         height="12">
                      <path stroke-linecap="round" stroke-linejoin="round"
