...
const handleSubmit = async () => {
  ...
  try {
    ...
    successModal.value.vehicleNumber = form.vehicleNumber
      ...
      <div class="card">
        ...
        <div class="form-body">
          ...
          <div class="form-group">
            ...
            <input class="form-input" :class="{ error: error.vehicleNumber }" type="text" placeholder="예: 12가3456"
          ...
          <div class="form-group">
            ...
            <input class="form-input" :class="{ error: error.visitorName }" type="text" placeholder="방문자 이름을 입력하세요"
          ...
          <div class="form-group">
            ...
            <input class="form-input" :class="{ error: error.purpose }" type="text" placeholder="방문 목적을 선택하거나 직접 입력하세요"
                   v-model="form.purpose"/>
            <div class="tag-list">
              <button v-for="tag in purposeTags" :key="tag"
                      :class="['tag-btn', form.purpose === tag ? 'tag-active' : '']" @click="selectPurposeTag(tag)">
                {{ tag }}
              </button>
            </div>
          ...
          <div class="form-row">
            <div class="form-group">
              ...
              <input class="form-input" :class="{ error: error.startDate }" type="date" :min="today"
            ...
            <div class="form-group">
              ...
              <input class="form-input" type="date" :min="form.startDate || today" v-model="form.endDate"/>
            </div>
          </div>
