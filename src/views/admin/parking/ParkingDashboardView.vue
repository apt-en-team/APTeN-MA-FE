    ...
    <div class="dashboard-grid">
        ...
        <div class="usage-section">
          ...
          <div class="usage-bar">
            <div
                ...
                :class="{
                  'fill-danger':  usageRate >= 90,
                  'fill-warning': usageRate >= 70 && usageRate < 90,
                  'fill-safe':    usageRate < 70,
                }"
            />
          </div>
      ...
      <div class="card">
        ...
        <div class="chart-wrap">
          <VueApexCharts
              v-if="!state.loading && state.currentCount > 0"
              type="donut"
              height="300"
        ...
        <div class="legend">
          <div class="legend-item">
            ...
            <span class="legend-label">등록 차량</span>
            <span class="legend-value">{{ state.registeredCount }}대</span>
          </div>
          <div class="legend-item">
          ...
          <div class="legend-item">
            ...
            <span class="legend-label">미등록</span>
            <span class="legend-value">{{ state.unregisteredCount }}대</span>
          </div>
        </div>
      </div>
