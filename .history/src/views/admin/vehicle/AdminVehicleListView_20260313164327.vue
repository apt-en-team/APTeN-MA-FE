...
const columns = [
  ...
  { label: '소속 세대', key: 'householdAddress' },  // ← 추가
  ...
  <div class="vehicle-list-view">
    ...
    <div class="table-section">
      ...
      <AdminTable :columns="columns" :rows="state.list">
        ...
        <!-- ← 추가 -->
        <template #cell-householdAddress="{ row }">
          <span class="td-clickable" @click="openDetailModal(row)">{{ row.householdAddress ?? '-' }}</span>
        </template>
    ...
    >
      <div class="detail-hero">
        ...
        <!-- ← 세대 정보 추가 -->
        <p class="detail-sub">{{ detailModal.vehicle?.carModel ?? '-' }} · {{ detailModal.vehicle?.householdAddress ?? '-' }}</p>
      </div>
      ...
      <div class="detail-grid">
        ...
        <div class="detail-cell">
          ...
          <span class="detail-cell-value">{{ detailModal.vehicle?.householdAddress ?? '-' }}</span>
        </div>
        <div class="detail-cell">
    ...
    >
      <div class="confirm-vehicle-card">
        ...
        <!-- ← 세대 정보 추가 -->
        <p class="confirm-vehicle-sub">{{ approveModal.vehicle?.carModel ?? '-' }} · {{ approveModal.vehicle?.householdAddress ?? '-' }}</p>
      </div>
    ...
    >
      <div class="confirm-vehicle-card">
        ...
        <!-- ← 세대 정보 추가 -->
        <p class="confirm-vehicle-sub">{{ rejectModal.vehicle?.carModel ?? '-' }} · {{ rejectModal.vehicle?.householdAddress ?? '-' }}</p>
      </div>
